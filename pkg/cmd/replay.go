...
func newCtlReplayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			err = replayCommand(cmd.Context(), etcdclient, flags, args)
...
func replayCommand(ctx context.Context, etcdclient client.Client, flags *replayFlagpole, args []string) error {
	...
	if flags.Snapshot {
		...
		slog.Info("Restoring snapshot and replaying")
	}
