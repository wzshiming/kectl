...
func newCtlRecordCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			err = recordCommand(cmd.Context(), etcdclient, flags, args)
...
func recordCommand(ctx context.Context, etcdclient client.Client, flags *recordFlagpole, args []string) error {
